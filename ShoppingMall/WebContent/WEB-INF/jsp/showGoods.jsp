	...
	<div class="content">
		...
		<table class="table">
					...
					<%-- <div class="right">
						...
						<div class="right">
							<a href="${pageContext.request.contextPath }/User/logout"
								style="text-decoration: none;" class="href">注销</a> &nbsp;|&nbsp;
						</div>
			...
			<tr class="tr2">
				...
				<td>
					<div id="container">
						<div id="list" style="left: -170px;">
							<img src="${image[2].imgSrc }" alt="3" class="picture" /> <img
								src="${image[0].imgSrc }" alt="1" class="picture" /> <img
								src="${image[1].imgSrc }" alt="2" class="picture" /> <img
								src="${image[2].imgSrc }" alt="3" class="picture" /> <img
				...
				submitBtn.onclick = function(event) {
					...
					if(type == "" || price == "" || color == ""){
						alert("请选择类型和颜色");
						return false;
					}else if(n < 1 || parseInt(n) > parseInt(quantity)){
						console.log(n)
						console.log(quantity)
						console.log(parseInt(n) > parseInt(quantity))
						console.log(5 > 30)
						alert("库存不足!!");
						return false;	
					}else{
